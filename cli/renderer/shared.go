...
// getRenderedRowLines returns channel of strings representing rows in the crossword
...
// getRenderedColumnLines returns channel of strings representing columns in the crossword
